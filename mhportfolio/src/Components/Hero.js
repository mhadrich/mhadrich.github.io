...
function Hero() {
  return (
    <div className="dark:bg-black items-center justify-center w-screen px-20">
      <div className="inline-flex">
        <div className="flex flex-col gap-6">
          ...
          <text className="w-[50%] dark:text-white font-light font-['Open Sans']">
            An experienced visual content producer, Full-stack Developer with a
            passion to learn and desire to innovate. Always on the lookout for
            new challenges, and excited to be part of a team that can push the
          ...
          <div className="flex flex-row gap-6">
            ...
            <div className="w-48 h-12 p-2 rounded-3xl border border-black dark:border-secondary justify-center items-center gap-1 inline-flex">
        ...
        <div className="h-[620px]">
          <div className=" mr-20 bg-primary rounded-full flex-col justify-end items-center inline-flex">
            <img className="rounded-full" src={portrait} alt="portrait" />
          </div>
          <div className="flex flex-col gap-2 shadow-2xl bg-[#f9f9f9] dark:bg-tertiary w-32 h-28 rounded-2xl right-[24%] bottom-[50%] items-center justify-center">
